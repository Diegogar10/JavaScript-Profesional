...
var matrizAsociacion =
/** @class */
function () {
  function matrizAsociacion() {
    var _this = this;

    this.value = new BitcoinPrice();
    this.el = document.querySelectorAll('.price');
    this.bt = document.querySelectorAll('.Suscribe');
    this.myMap = new Map();
    this.bt.forEach(function (boton, i) {
      _this.myMap.set(boton, _this.el[i]);

      boton.addEventListener("click", function () {
        var value = _this.myMap.get(boton);

        _this.creaInstancia(value, boton);
      });
    });
  }

  matrizAsociacion.prototype.creaInstancia = function (value, boton) {
    this.boton = boton;
    var display = new PriceDisplay(value);
  ...
  return matrizAsociacion;
}();

var PriceDisplay =
/** @class */
function () {
  function PriceDisplay(display, boton) {
    this.el = display;
    this.bt = boton;
  }
...
var botones = new matrizAsociacion(); //const display = new PriceDisplay();
