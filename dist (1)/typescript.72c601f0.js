...
var people = [];
people = ['Isabel', 'Nicole', 'Raul']; //people.push(9000)  --- esto seria un error por el tipo de elemento ingresado

people.push('9000'); //Arreglos combinados

var peoplesandnumbers = [];
peoplesandnumbers.push('Diego');
peoplesandnumbers.push(28); //Enum
...
var fourPlus6 = addFour(6); //valor no requerida

function fullName(firstName, lastName) {
  return firstName + " " + lastName;
}

var richard = fullName('Richard'); //valor por defecto

function fullNameDefault(firstName, lastName) {
  if (lastName === void 0) {
    lastName = 'Smith';
  }
